import { i as __toESM$1, n as __exportAll, t as __commonJSMin$1 } from "./rolldown-runtime-B4lejLz5.js";
import { n as require_browser_external_node_process, t as require_browser_external_node_tty } from "./browser-external_node_tty-CPCLl9OG.js";
import { t as require_browser_external_node_path } from "./browser-external_node_path-XVCMDVhG.js";
import { t as require_promises } from "./promises-DT3PFBwi.js";
...
var require_browser_external_node_module = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	module.exports = Object.create(new Proxy({}, { get(_, key) {
...
//#endregion
//#region ../../node_modules/.pnpm/rolldown@1.1.5/node_modules/rolldown/dist/shared/logs-ZGEh6uhb.mjs
...
var MULTIPLE_WATCHER_OPTION = "MULTIPLE_WATCHER_OPTION";
...
//#endregion
//#region ../../node_modules/.pnpm/rolldown@1.1.5/node_modules/rolldown/dist/shared/binding-TuFFIE_J.mjs
...
//#endregion
//#region ../../node_modules/.pnpm/rolldown@1.1.5/node_modules/rolldown/dist/shared/parse-D4dtlfWy.mjs
...
//#endregion
//#region ../../node_modules/.pnpm/rolldown@1.1.5/node_modules/rolldown/dist/parse-ast-index.mjs
...
//#endregion
//#region ../../node_modules/.pnpm/rolldown@1.1.5/node_modules/rolldown/dist/shared/normalize-string-or-regex-dnh67V_w.mjs
...
//#endregion
//#region ../../node_modules/.pnpm/rolldown@1.1.5/node_modules/rolldown/dist/shared/error-BHRSI0R7.mjs
...
//#endregion
//#region ../../node_modules/.pnpm/rolldown@1.1.5/node_modules/rolldown/dist/shared/misc-CoQm4NHO.mjs
...
//#endregion
//#region ../../node_modules/.pnpm/rolldown@1.1.5/node_modules/rolldown/dist/shared/bindingify-input-options-XPJLJOD0.mjs
...
Object.defineProperty(import_binding$3.BindingMagicString.prototype, "isRolldownMagicString", {
	value: true,
	writable: false,
	configurable: false
});
...
var nativeAppend = import_binding$3.BindingMagicString.prototype.append;
var nativePrepend = import_binding$3.BindingMagicString.prototype.prepend;
var nativeAppendLeft = import_binding$3.BindingMagicString.prototype.appendLeft;
var nativeAppendRight = import_binding$3.BindingMagicString.prototype.appendRight;
var nativePrependLeft = import_binding$3.BindingMagicString.prototype.prependLeft;
var nativePrependRight = import_binding$3.BindingMagicString.prototype.prependRight;
var nativeOverwrite = import_binding$3.BindingMagicString.prototype.overwrite;
var nativeUpdate = import_binding$3.BindingMagicString.prototype.update;
import_binding$3.BindingMagicString.prototype.append = function(content) {
	assertString(content, "outro content must be a string");
	return nativeAppend.call(this, content);
};
import_binding$3.BindingMagicString.prototype.prepend = function(content) {
	assertString(content, "outro content must be a string");
	return nativePrepend.call(this, content);
};
import_binding$3.BindingMagicString.prototype.appendLeft = function(index, content) {
	assertString(content, "inserted content must be a string");
	return nativeAppendLeft.call(this, index, content);
};
import_binding$3.BindingMagicString.prototype.appendRight = function(index, content) {
	assertString(content, "inserted content must be a string");
	return nativeAppendRight.call(this, index, content);
};
import_binding$3.BindingMagicString.prototype.prependLeft = function(index, content) {
	assertString(content, "inserted content must be a string");
	return nativePrependLeft.call(this, index, content);
};
import_binding$3.BindingMagicString.prototype.prependRight = function(index, content) {
	assertString(content, "inserted content must be a string");
	return nativePrependRight.call(this, index, content);
};
import_binding$3.BindingMagicString.prototype.overwrite = function(start, end, content, options) {
	assertString(content, "replacement content must be a string");
	return nativeOverwrite.call(this, start, end, content, options);
};
import_binding$3.BindingMagicString.prototype.update = function(start, end, content, options) {
	assertString(content, "replacement content must be a string");
	return nativeUpdate.call(this, start, end, content, options);
};
var nativeReplace = import_binding$3.BindingMagicString.prototype.replace;
var nativeReplaceAll = import_binding$3.BindingMagicString.prototype.replaceAll;
import_binding$3.BindingMagicString.prototype.replace = function(searchValue, replacement) {
...
import_binding$3.BindingMagicString.prototype.replaceAll = function(searchValue, replacement) {
...
* @experimental
*/
var RolldownMagicString = import_binding$3.BindingMagicString;
...
function bindingifyExperimental(experimental) {
	let chunkModulesOrder = import_binding$3.BindingChunkModuleOrderBy.ExecOrder;
	if (experimental?.chunkModulesOrder) switch (experimental.chunkModulesOrder) {
		case "exec-order":
			chunkModulesOrder = import_binding$3.BindingChunkModuleOrderBy.ExecOrder;
			break;
		case "module-id":
			chunkModulesOrder = import_binding$3.BindingChunkModuleOrderBy.ModuleId;
			break;
...
function bindingifyTreeshakeOptions(config) {
	...
	switch (config.propertyReadSideEffects) {
		case "always":
			normalizedConfig.propertyReadSideEffects = import_binding$3.BindingPropertyReadSideEffects.Always;
			break;
		case false:
			normalizedConfig.propertyReadSideEffects = import_binding$3.BindingPropertyReadSideEffects.False;
			break;
		default:
	}
	switch (config.propertyWriteSideEffects) {
		case "always":
			normalizedConfig.propertyWriteSideEffects = import_binding$3.BindingPropertyWriteSideEffects.Always;
			break;
		case false:
			normalizedConfig.propertyWriteSideEffects = import_binding$3.BindingPropertyWriteSideEffects.False;
			break;
		default:
	}
...
//#endregion
//#region ../../node_modules/.pnpm/rolldown@1.1.5/node_modules/rolldown/dist/shared/rolldown-build-CtPvmZgJ.mjs
...
function createConsola(options = {}) {
	...
	return createConsola$1({
		...
		prompt: (...args) => import("./prompt--dNycKSZ-BEbMQI3k.js").then((m) => m.prompt(...args)),
...
//#endregion
//#region ../../node_modules/.pnpm/rolldown@1.1.5/node_modules/rolldown/dist/shared/watch-B1b0gmVh.mjs
/**
...
async function createWatcher(emitter, input) {
	...
	new Watcher(emitter, new import_binding$1.BindingWatcher(bundlerOptions.map((option) => option.bundlerOptions), callback), bundlerOptions.map((option) => option.stopWorkers));
}
...
//#endregion
//#region ../../node_modules/.pnpm/rolldown@1.1.5/node_modules/rolldown/dist/shared/rolldown-ChpIlMRm.mjs
/**
...
//#endregion
//#region ../../node_modules/.pnpm/rolldown@1.1.5/node_modules/rolldown/dist/index.mjs
...
if (import_browser_external_node_worker_threads.isMainThread) {
...
//#endregion
export { parseSync as C, require_browser_external_node_util as D, require_browser_external_node_module as E, parse as S, require_binding as T, BuiltinPlugin as _, createBundlerOptions as a, parseAst as b, VERSION as c, isPromiseLike as d, require_browser_external_node_worker_threads as f, unwrapBindingResult as g, normalizeBindingResult as h, RolldownBuild as i, transformToRollupOutput as l, normalizeBindingError as m, rolldown as n, validateOption as o, bindingifySourcemap$1 as p, PluginDriver as r, require_browser_external_node_os as s, dist_exports as t, arraify as u, makeBuiltinPluginCallable as v, __toESM as w, parseAstAsync as x, normalizedStringOrRegex as y };
