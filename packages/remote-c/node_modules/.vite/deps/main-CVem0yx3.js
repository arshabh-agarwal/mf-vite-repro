...
import { t as require_browser_external_child_process } from "./browser-external_child_process-B_ClrSVh.js";
...
//#endregion
//#region browser-external:tty
var require_browser_external_tty = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = Object.create(new Proxy({}, { get(_, key) {
		if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") console.warn(`Module "tty" has been externalized for browser compatibility. Cannot access "tty.${key}" in client code. See https://vite.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.`);
	} }));
}));
//#endregion
...
for your current platform.`);
	...
	var path2 = require_browser_external_path();
	var fs2 = require_browser_external_fs();
	var os2 = require_browser_external_os();
	var tty = require_browser_external_tty();
	var worker_threads;
	if (process.env.ESBUILD_WORKER_THREADS !== "0") {
		try {
			worker_threads = require_browser_external_worker_threads();
		} catch {}
